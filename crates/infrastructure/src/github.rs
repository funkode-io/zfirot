...
use domain::{parse_prose, AppError, AppResult, PrdRef, ProseLinks, RawSlice, RepoRef, Slice};
...
/// The native sub-issue parent of an issue, carrying the PRD identity to group
/// and link the board lane by.
#[derive(Debug)]
struct NativeParent {
    number: u64,
    title: String,
